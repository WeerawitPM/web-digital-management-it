...
export default function Component() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('/api/it-manager/documents/QF-ITC-0001'); // เรียกใช้งาน API ที่เส้นทาง '/api'
                    ...
                    <div className="flex flex-row flex-wrap justify-center items-center gap-5">
                        <div className="p-5 bg-white rounded shadow-md">
                            <div className="flex flex-col">
                                ...
                                <Link
                                    href={`/it-manager/documents/QF-ITC-0001/detail/${0}`}
                        ...
                        <div className="p-5 bg-white rounded shadow-md">
                            <div className="flex flex-col">
                                ...
                                <Link
                                    href={`/it-manager/documents/QF-ITC-0001/detail/${1}`}
                                    className="font-medium ms-40"
                                >
                        ...
                        <div className="p-5 bg-white rounded shadow-md">
                            <div className="flex flex-col">
                                ...
                                <Link
                                    href={`/it-manager/documents/QF-ITC-0001/detail/${2}`}
                                    className="font-medium ms-40"
                                >
