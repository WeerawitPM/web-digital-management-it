                    ...
                    <div className="flex flex-row flex-wrap justify-center items-center gap-5">
                        <Card className="p-5 rounded">
                            <div className="flex flex-col">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <div className="text-gray-400 text-lg">รอรับรองผลการดำเนินงาน</div>
                                ...
                                <Link
                                    href={`/it-manager/documents/QF-ITC-0003/detail/${0}`}
                        ...
                        <Card className="p-5 rounded">
                            <div className="flex flex-col">
                                ...
                                <Link
                                    href={`/it-manager/documents/QF-ITC-0003/detail/${1}`}
                                    className="font-medium ms-40"
                                >
                        ...
                        <Card className="p-5 rounded">
                            <div className="flex flex-col">
                                ...
                                <Link
                                    href={`/it-manager/documents/QF-ITC-0003/detail/${2}`}
                                    className="font-medium ms-40"
                                >
