...
export function SidebarComponent({ name }: { name: string }) {
        ...
        <>
            <Navbar position="static" isBordered maxWidth="xl">
                <NavbarContent justify="start">
                    ...
                    <span className="font-semibold text-md text-foreground leading-tight">
                        Admin - {name}
                    </span>
                </NavbarContent>
            </Navbar>
            ...
            <aside
                ...
                aria-label="Sidebar"
            >
                <div className="h-full px-3 py-4 overflow-y-auto shadow-lg mt-0.5">
