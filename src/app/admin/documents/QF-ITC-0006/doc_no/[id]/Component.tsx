...
export default function Component(
    ...
    const saveData = (status: number) => {
        ...
        axios.patch('/api/admin/documents/QF-ITC-0006/approve', formData)
            .then(response => {
    ...
    const handleUpdateDate = () => {
        ...
        axios.patch('/api/admin/documents/QF-ITC-0006/close', formData)
            .then(response => {
                if (response.data.status === "success") {
                    toast({
                        title: 'Success',
                ...
                {data === null ? "" :
                    <>
                        ...
                        <Card className="p-4 sm:p-8 sm:rounded-lg flex flex-col gap-5">
                            ...
                            <div>
                                <RadioGroup
                                    defaultValue={data?.Table_ITC_0006[0]?.email_type}
                                    orientation="horizontal"
                                    isReadOnly
                                >
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                {data?.step === 1 && trackStatus === 1 && data?.Table_ITC_0006[0]?.end_date === null
                                    ?
                                    <div className="flex flex-col gap-2">
                                    ...
                                    :
                                    <div>วันที่เลิกใช้งาน: {data?.Table_ITC_0006[0]?.end_date && new Date(data?.Table_ITC_0006[0]?.end_date).toLocaleDateString('th-TH')}</div>
                                }
                            </div>
                        </Card>
