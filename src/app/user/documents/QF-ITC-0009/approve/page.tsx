...
import Component from "@/components/documents/QF-ITC-0009/doc_no/Component";
...
export default function Home({ params }: { params: any }) {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`/api/documents/QF-ITC-0009/doc_no?doc_no=${doc_no}`);
    ...
    return (
        <Component data={data} steps={steps} statusStep={statusStep} doc_no={doc_no} trackStatus={trackStatus} />
    );
}