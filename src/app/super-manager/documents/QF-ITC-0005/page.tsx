"use client"
import Component from "@/components/documents/QF-ITC-0005/Component";
...
export default function Home() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get('/api/user/documents/QF-ITC-0005'); // เรียกใช้งาน API ที่เส้นทาง '/api'
