...
export default function Component(
    ...
    const saveData = (status: number) => {
        ...
        axios.patch('/api/manager/documents/QF-ITC-0003/accept', formData)
            .then(response => {
                            ...
                            <Card className="p-4 sm:p-8 sm:rounded-lg w-75">
                                <CardBody>
                                    <div className="mx-auto text-center mt-2">
                                        <Button colorScheme="green" className="mr-1" onClick={() => handleConfirmSave(1)}>รับมอบระบบ</Button>
                                        <Button colorScheme="red" onClick={() => handleConfirmSave(2)}>ปฏิเสธการรับมอบ</Button>
                                    </div>
