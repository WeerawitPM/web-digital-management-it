...
import HeaderMain from "@/components/documents/QF-ITC-0006/HeaderMain";

export default function Component({ data, role }: { data: any, role: any }) {
    return (
        <>
                    ...
                    <div className="flex flex-row flex-wrap justify-center items-center gap-5">
                        <Card className="p-5 rounded">
                            <div className="flex flex-col">
                                ...
                                <Link
                                    href={`/${role}/documents/QF-ITC-0006/detail/${0}`}
                        ...
                        <Card className="p-5 rounded">
                            <div className="flex flex-col">
                                ...
                                <Link
                                    href={`/${role}/documents/QF-ITC-0006/detail/${1}`}
                                    className="font-medium ms-40"
                                >
                        ...
                        <Card className="p-5 rounded">
                            <div className="flex flex-col">
                                ...
                                <Link
                                    href={`/${role}/documents/QF-ITC-0006/detail/${2}`}
                                    className="font-medium ms-40"
                                >
