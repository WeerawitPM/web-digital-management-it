            ...
            <tbody>
                ...
                <tr>
                    <td className="flex flex-row gap-3">
                        <div className="flex flex-row gap-1">
                            <Image
                                src={requestFor?.email_type === ".vcs.co.th" ? checked : uncheck}
                                alt='checkbox'
                                height={20}
                                width={20}
                                unoptimized
                        ...
                        <div className="flex flex-row gap-1">
                            <Image
                                src={requestFor?.email_type === ".vcst.co.th" ? checked : uncheck}
                                alt='checkbox'
                                height={20}
                                width={20}
                                unoptimized
                        ...
                        <div className="flex flex-row gap-1">
                            <Image
                                src={requestFor?.email_type === ".tkm.co.th" ? checked : uncheck}
                                alt='checkbox'
                                height={20}
                                width={20}
                                unoptimized
